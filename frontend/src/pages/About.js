    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-teal-50" >
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-t from-black/75 to-transparent flex items-center justify-center z-10">
          ...
          >
            <motion.h1
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white drop-shadow-lg tracking-tight"
            ...
            <motion.p
              className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-200 mt-3 sm:mt-4 max-w-3xl mx-auto drop-shadow-md"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            <div className="space-y-4 sm:space-y-5 md:space-y-6">
              ...
              >
                <Link
                  to="/bookings"
                  className="inline-block bg-blue-600 text-white font-semibold py-2.5 sm:py-3 px-5 sm:px-6 rounded-lg shadow-md text-sm sm:text-base"
                >
                  <motion.span
            ...
            >
              <motion.img
                ...
                className="rounded-xl shadow-xl w-full h-auto max-h-[300px] sm:max-h-[400px] md:max-h-[500px] object-cover"
